...
public class Types {
	...
	public enum Type implements EntityType {
		PLAYER, SPAWN_POINT, NEXT_LEVEL_POINT, ENEMY, BOSS, PLATFORM, BLOCK, TRIGGER, POWERUP, PLAYER_PROJECTILE, ENEMY_PROJECTILE, LIMIT, BACKGROUND, PLAYER_COL_BOX, PLAYER_PIC_BOX, PROP, ENEMY_SPAWNER, BOSS_SPAWNER
	}
