...
public class CannonControl extends AbstractControl {

	private Entity target;
	private boolean spearThrown;
	
	public CannonControl(Entity target) {
		this.target = target;
		spearThrown = false;
	}
	...
	private boolean isTargetInRange() {
		return target.getPosition().distance(entity.getPosition()) <= Config.ENEMY_FIRE_RANGE*1.5;
	}
}