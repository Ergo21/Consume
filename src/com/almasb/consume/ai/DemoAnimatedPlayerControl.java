...
public class DemoAnimatedPlayerControl implements Control {

	private enum AnimationChannel {
		IDLER(new Rectangle2D(150, 0, 90, 30), 3), IDLEL(new Rectangle2D(60, 0, 90, 30),
	...
	public DemoAnimatedPlayerControl(Texture spritesheet) {
